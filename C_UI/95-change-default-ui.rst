...
.. image:: /Images/95-change-default-ui/95-selecting-default-ui.png
   :align: center
...
#. Go to *Settings > Project Options*.
   ...
   .. image:: /Images/95-change-default-ui/project-options.jpg
      :align: center

#. In *AIMMS Options*, expand the *Project* directory and select *Appearance*.
    
   .. image:: /Images/95-change-default-ui/appearance-options.jpg
      :align: center
