...
.. meta::
   :description: Implements the Optimal Power Flow problem for the IEEE 14-bus system in AIMMS, minimizing total generation cost subject to nodal power balance and branch capacity constraints.
   :keywords: Optimal Power Flow, OPF, power systems, IEEE 14-bus, NLP, generation cost, MATPOWER, branch model, bus voltage
...
.. figure:: images/branch_model.png
    :scale: 40%
    :align: center
...
.. |current_data_icon| image:: images/current_data.png
...
.. image:: images/main_variables.png
    :align: center
...
.. image:: images/ineq_constraints.png
    :align: center
...
.. image:: images/opf_solution_page_webui.png
    :align: center
