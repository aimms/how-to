...
You can use the chart in `WebUI Annotations - Widget and CSS support <https://documentation.aimms.com/webui/folder.html#css-styling>`_ for a reference of elements and their corresponding CSS properties.
