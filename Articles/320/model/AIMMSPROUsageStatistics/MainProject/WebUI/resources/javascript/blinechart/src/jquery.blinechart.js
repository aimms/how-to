      ...
      if (optionName === 'contents') {
        if (value) {
          ...
          value.requestDataBlocks(ranges, function onReady(layeredDataBlocks) {
            widget.parts = {
              values: $.extend({}, value.values, layeredDataBlocks.values),
              header: $.extend({}, value.header, layeredDataBlocks.header),
              layers: $.extend({}, value.layers, layeredDataBlocks.layers)
            };
