...
**Use it locally:** Download this toolkit and open ``api-init/Data_Lake_Storage.txt``. Add your ``StorageAccount`` and your ``StorageAccount`` replacing ``"add_name_here"`` string. Open the project. 
