...
.. meta::
   :description: Solves a single-level small bucket lot-sizing MIP problem where production in a period triggers discrete events such as setup costs or capacity loss.
   :keywords: lot sizing, production planning, MIP, small bucket, setup cost, Lotsizelib, discrete event
