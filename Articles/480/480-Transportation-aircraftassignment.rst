...
.. meta::
   :description: Maximizes profit from allocating aircraft to flight routes using a linear programming formulation based on Dantzig's classical transportation model.
   :keywords: aircraft assignment, LP, linear programming, transportation, profit maximization, Dantzig
