...
.. meta::
   :description: Locates a set of warehouses to service customers at minimum cost, subject to capacity constraints on total demand served per warehouse, formulated as a small MIP.
   :keywords: capacitated warehouse location, MIP, facility location, demand constraints, cost minimization, OR-Library
