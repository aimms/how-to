...
AIMMS WebUI is a web-based interface within AIMMS that enables users to create interactive dashboards for visualizing and exploring their optimization models and data in real time. 
Designed for ease of use, the WebUI allows users to build intuitive applications that can be accessed and used by non-technical stakeholders, 
