...
To obtain the above code, please see the instructions in the post :doc:`../introduction/145-import-export-section` to export the section ``Stopwatch support`` from the example model below and import this ``.ams`` file into your own project. 
