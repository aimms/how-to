...
You can download the above code as an ``.ams`` file from the link below. Please see the instructions in the post :doc:`145-import-export-section` to import this aim file into your own project. If your project already contains the SI_Time quantity, please remove the quantity from the ``.ams`` file after downloading it.
